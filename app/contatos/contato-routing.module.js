...
var contato_lista_component_1 = require("./contato-lista.component");
var contato_detalhe_component_1 = require("./contato-detalhe.component");
var contatoRoutes = [
    {
        path: 'contato',
        component: contato_lista_component_1.ContatosListaComponent,
    },
    {
        path: 'contato/save',
        component: contato_detalhe_component_1.ContatosDetalheComponent,
    },
    {
